...
- **BEFORE** writing code, creating files, or executing terminal commands, you MUST provide a plan.
- **HARD STOP:** After your plan, you must output exactly this text:
  > "I am now standing by for your approval. Please say 'Proceed' to execute this plan."
- **STRICT RULE:** You are FORBIDDEN from creating files or writing code in the same message as your plan.

[ ] 2. VERIFICATION PROTOCOL

- Once I say "Proceed," you must execute the task and then immediately run a verification (e.g., `ls -l` to check the file exists or `cat` to verify content).
- Show me the results of this verification to prove the task is "Done."
